...
void PlayMode::Init() {
	...
	World::AddObject(std::make_shared<Ball>(m, glm::vec3(0, 110, 50), glm::vec3(pixel_per_cm * 0.0f, 0.0f, pixel_per_cm * 500.0f)));
	World::AddObject(std::make_shared<Ball>(m, glm::vec3(0, 110, 0), glm::vec3(0, 0, 0)));
